...
from .analise import detalhes, estatisticas, fila_analise, historico, painel_analise, solicitar_correcao
...
from .operacional import gerar_mapa_eventos_pdf as _gerar_mapa_eventos_pdf_original
